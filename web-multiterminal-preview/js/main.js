...
document
  .querySelector(".desktop-input")
  .addEventListener("input", desktopRender);
...
// 实例
document.querySelector(".desktop-input").value =
  "https://electronic-sheep721.github.io/sheep128/";
document.querySelector(".laptop-input").value =
  "https://electronic-sheep721.github.io/sheep128/";
document.querySelector(".tablet-input").value =
  "https://electronic-sheep721.github.io/sheep128/";
